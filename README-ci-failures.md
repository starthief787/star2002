...
2. Look for the newly generated images on
   ...
   with `-buster`, `-bullseye`, `-stretch` and `-bookworm` (Debian versions).

   The relevant sha256 digest can also be found on the last line of successful
   `Docker: toolchain-*` jobs, as, e.g., `bc072cd-bullseye-devnet: digest:
   sha256:46931fab239147217b4eaec0ebafab645cc6c02687b061b73b8c0763b23d02af size:
   6226`
